                ...
                <h2 className = "tile is-ancestor ">
                    <p className="tile is-5 is-parent">
                        <p className="tile is-child box has-text-centered FINDSENPAI">
                            ...
                            <br></br>
                            <Link to='/catalog' className="button is-medium is-danger is-rounded"><strong> FIND SENPAI </strong></Link>  
                        </p>
                    </p>
                    ...
                    <p className="tile is-5 is-parent">
                        <p className="tile is-child box has-text-centered BESENPAI">
                            ...
                            {/* <img src="https://bulma.io/images/placeholders/640x480.png"></img> */}
                            <br></br>
                            <Link to='/register' className="button is-medium is-warning is-rounded"><strong> BE SENPAI </strong></Link>
                        </p>
                    </p>
                </h2>
            {/* </p> */}
